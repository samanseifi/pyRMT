...
for file_path in file_paths:
    ...
    cf = ax.contourf(X, Y, a_masked, levels=50, cmap="Spectral_r")
    ...
    ax.set_title("Deformation of Soft Disc in Lid-Driven Cavity Flow", fontsize=12)
    ax.set_aspect('equal')
    plt.axis('off')
...
imageio.mimsave(gif_path, images, fps=40)
