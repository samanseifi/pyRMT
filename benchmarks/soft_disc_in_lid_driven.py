...
if __name__ == "__main__":
    ...
    directory_name = "output_lid_driven_soft_disc_4"
    ml_obj = None
    ...
    for step in range(1, max_steps + 1):
        ...
        a_star, b_star = velocity_RK4(a, b, p, X1, X2, lid_bc, mu_s, kappa, eta_s, dx, dy, dt, rho_s, rho_f, phi, mu_f, w_t, gamma)
        ...
        a, b, p, A, ml = pressure_projection_amg(
            ...
            rho_local,              # scalar density here
            velocity_bc=lid_bc,
            A=A, ml=ml_obj,
            p_prev=p
        )
        
        # a, b, p = pressure_projection_direct_RC(
        #     a_star, b_star, dx, dy, dt, rho_local, mu_f, lid_bc, 
        #     solver_factorized=solve_pressure, 
        #     pin_idx=pin_idx, 
        #     p_prev=p
        # )
