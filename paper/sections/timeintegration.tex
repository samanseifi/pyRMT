...
map transported by the implicit-midpoint velocity; (ii) advection is made
unconditionally stable by a semi-Lagrangian (RK2 backtrace, cubic interpolation) update
of the momentum, removing the last explicit CFL $\dx/U$; and (iii) the viscous
